...
public class BaseStepDefinition {
	...
	public void initiation()
	{
		...
		prop = getProperties();
		if(td==null)
		td = GetTestData(System.getProperty("user.dir")+"/src/test/resources/TestData/TestData.xlsx","Sheet1");
	...
	public void createReport()
	{
		...
		htmlReporter = new ExtentHtmlReporter(System.getProperty("user.dir") + "/src/test/java/com/Nova/reports/ExtentReport"+fileName+".html");
